"""Service helpers for metrics of individual point clouds."""
...
from .singlecloud_metrics import (
    calc_single_cloud_stats as _calc_single_cloud_stats,
)
...
def calc_single_cloud_stats(
    ...
    *,
    ...
    For each entry in ``folder_ids`` the function evaluates the provided point
    cloud using :func:`m3c2.statistics.singlecloud_metrics.calc_single_cloud_stats`
    and writes the aggregated results to disk.
    """
